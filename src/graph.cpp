...
void Graph::SaveAsHtml(std::string output_FileName)
{
    ...
    output_Stream << "<br><center><p>Copyright (c) 2010 <a href=\"http://alexnevsky.com\">Alex A. Nevsky</a>. GNU General Public License.</p></center></body></html>";
